...
public final class ImagenNoEncontrada {
    ...
    public ImagenNoEncontrada(String mensaje,final JScrollPane scrollImage, final JSlider jSlider1, int zoomImage, JTable tablaMetadata1) {
